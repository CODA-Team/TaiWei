...
def parse_args(
    ...
    p.add_argument(
        ...
        help=
        "Extra ssh options for remote ORD eval (default from env: ORD_EVAL_SSH_OPTS).",
    )
...
def main() -> int:
    ...
    default_remote_host = os.environ.get("ORD_EVAL_REMOTE_HOST",
                                         socket.gethostname())
    default_remote_project_dir = os.environ.get("ORD_EVAL_REMOTE_PROJECT_DIR",
                                                default_repo_root)
    ...
    print("[MAIN] env CDS_PARTITION_MODE={}"
